...
def calc_pure_python(draw_output, desired_width, max_iterations):
    ...
    # this sum is expected for 1000^2 grid with 300 iterations for c_real, c_imag = -0.62772, -.42193
    # assert sum(output) == 33219980
    
    print("Sum of the output list: ", sum(output))
